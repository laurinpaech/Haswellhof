...
outputFileName = 'response_layers_runtime_complete.pdf'
...
plt.title('Response Layers - Complete Runtime Optimizations', x=-0.31, y=1.05, ha='left', fontsize=16,
          fontweight='bold')

# Initializing plot axis labels
#plt.xlabel('optimization versions', fontsize=10)
plt.xlabel('[mio. cycles]', fontsize=13)
#yl = plt.ylabel('Image Size 1024', fontsize=10, ha='left')
#yl.set_rotation(0)
