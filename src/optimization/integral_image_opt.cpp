...
float box_integral_with_padding(struct integral_image *iimage, int row, int col, int rows, int cols) {
    ...
    float A = data[r0 * width + c0];
    float B = data[r0 * width + c1];
    float C = data[r1 * width + c0];
    float D = data[r1 * width + c1];
