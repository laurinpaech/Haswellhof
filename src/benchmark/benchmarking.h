...
/*
inline void set_benchmark_data(char *image_name, int width, int height, char *function_name, int num_interest_points, long num_flops,
...
void perf_compute_integral_img(void (*function)(float *, int, int, float *), 
                               float *gray_image,
                               struct benchmark_data &data);

/*
void bench_compute_response_layer(const std::vector<void (*)(struct response_layer *, struct integral_image *)> &functions,
...
void perf_interpolate_step(void (*function)(int, int, struct response_layer *, struct response_layer *, struct response_layer *, float[3]),
                           int row, int col, struct response_layer *top, struct response_layer *middle, struct response_layer *bottom, 
                           struct benchmark_data &data);
